...
from utils import *
from dataset import People_Car_cl_Dataset
...
def main(config):
    ...
    # df = df.sample(1000)
    dataset_train = People_Car_cl_Dataset(df, args.fold, 'train', config.MODEL.img_size)
    dataset_valid = People_Car_cl_Dataset(df, args.fold, 'valid', config.MODEL.img_size)
